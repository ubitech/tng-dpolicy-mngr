...
import eu.tng.KieContainersManagement.KieUtil;
import eu.tng.PolicyengineApplication;
import static eu.tng.Util.createKjar;
import static eu.tng.Util.deployKjar;
